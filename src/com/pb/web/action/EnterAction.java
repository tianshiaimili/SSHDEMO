...
public class EnterAction extends BaseAction {
	private IUserBiz biz2;
	...
	public void setBiz2(IUserBiz biz2) {
		this.biz2 = biz2;
	}
	 ...
	 */
	public String enter() {
//		Map<String, Object> map=biz2.login(username, password); // 用户登录
